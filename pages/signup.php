...
<h2>Signup</h2>
  ...
  <div class="mb-3">
    ...
    <input type="password" name="password" class="form-control" id="inputPassword" minlength="6" required>
  </div>
  <div class="mb-3">
    <label for="inputPassword" class="form-label">Retype your Password</label>
    <input type="password" name="retypepassword" class="form-control" id="inputPassword" minlength="6" required>
  </div>
